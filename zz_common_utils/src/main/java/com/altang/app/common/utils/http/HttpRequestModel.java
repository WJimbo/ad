...
public class HttpRequestModel {
     ...
     */
    public static BaseResponseData synRequestData(HttpRequestData requestData,
...
//        System.gc();
     ...
     * @param listener
     */
    public static void asynRequestData(final HttpRequestData requestData, final Class<? extends BaseResponseData> dataModelClass, final OnLYHttpRequestResponseListener listener){
        OkHttpClient okHttpClient =  initHttpClient(requestData);
    ...
    private static Request createRequest(HttpRequestData requestData){

        Request.Builder requestBuilder = null;
        if(HttpRequestData.RequestModeType.POST == requestData.getRequestMode()){
        ...
        }else if(HttpRequestData.RequestModeType.GET == requestData.getRequestMode()){
            requestBuilder = new Request.Builder().url(requestData.getRequestURL() + requestData.getParamsString()).get();
        }else if(HttpRequestData.RequestModeType.PUT == requestData.getRequestMode()){
            //MediaType  设置Content-Type 标头中包含的媒体类型值
        ...
        }else if(HttpRequestData.RequestModeType.DELETE == requestData.getRequestMode()){
            RequestBody requestBody = FormBody.create(MediaType.parse("application/x-www-form-urlencoded; charset=utf-8")
                    , requestData.getBody());
    ...
    private static OkHttpClient initHttpClient(HttpRequestData requestData){
