...
public class ToastUtils {
    ...
    public static void showToastLong(final Context context, final CharSequence text) {
        if(context == null){
            return;
        }
        UIUtils.runOnMainThread(new Runnable() {
            ...
            public void run() {
                try {
                    ToolUtils.toast().showToastLong(context.getApplicationContext(),text.toString());
                }catch (Exception ex){
