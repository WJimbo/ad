...
import com.yunchuan.tingyanwu.ad.util.GsonUtil;
import com.yunchuan.tingyanwu.ad.util.LoggerHelper;
...
public class CommandReceiveService extends Service {
    ...
    private void refreshHeatBeatMessage(){
        ...
        messageData.setToken(SharedPreUtil.getString(this, "Mac", "") + System.currentTimeMillis());
        messageData.setCommond("M999");
        messageData.setmId(SharedPreUtil.getString(this, "Mac", ""));
        messageData.setConverType("ad");
        heartBeatMessage = GsonUtil.gson.toJson(messageData);
//        LoggerHelper.d("socket heartBeatData:" + heartBeatMessage);
    }
    private void initSocketClient(){
        socketClient = new SocketClient(new SocketClientAddress(CrashApplication.HOST,CommandReceiveConfig.SOCKET_PORT,CommandReceiveConfig.CONNECTION_TIMEOUT_MILL));
        /**
...
//                    byte[] data = responsePacket.getData(); // 获取接收的byte数组，不为null
                    ...
                    try {
                        ...
                        EventBus.getDefault().post(messageData.getCommond());
...
//                    LoggerHelper.i("onSendPacketBegin--->" + packet.isHeartBeat());
//                }
            }
...
//                if(!packet.isHeartBeat()){
//                    LoggerHelper.i("onSendPacketEnd");
//                }
            }
        });
    }
